...
-- DATE 타입의 컬럼에 문자타입의 값을 'YYY-MM-DD' 형태로 넣으면 자동으로 DATE타입으로 변환되어 들어간다
...
--VALUES('A', 'WHITE', 5, 'A1'); --대소문자를 구분하기 때문에 FK 'A1' 에 연결되어있는 'a1'과 동일하지 않는다
--VALUES('A', 'WHITE', 5, 'a1');
values('B', 'BLACK', 2, 'a2');
...
DELETE FROM TBL_PHONE ON DELETE cascade ;
