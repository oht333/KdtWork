...
SELECT PLAYER_ID , PLAYER_NAME , NVL2(NATION, '등록', '미등록') 
FROM PLAYER;
...
SELECT *
FROM PLAYER WHERE TEAM_ID IN (SELECT TEAM_ID FROM PLAYER WHERE PLAYER_NAME = '정남일');
...
SELECT * FROM PLAYER WHERE PLAYER_NAME = '정남일';
