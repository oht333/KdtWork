...
JOIN TBL_BOOKS TB ON TR.BOOK_ID = TB.BOOK_ID 
JOIN TBL_MEMBER TM ON TR.MEM_ID = TM.MEM_ID
WHERE TO_DATE('2023-12-25', 'YYYY-MM-DD') BETWEEN TR.REN_RENTALDATE AND TR.REN_RENTALDATE; 

-- 대여기간에 따라 책의 대여 상태
-- 3일 이하 단기대여, 7일 이상 장기 대여
